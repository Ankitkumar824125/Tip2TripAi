      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 shadow-2xl border border-white/20 glow-green-sm">
        ...
        <div className="text-center mb-8 space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-green/10 text-brand-green dark:bg-brand-yellow/10 dark:text-brand-yellow font-bold text-[10px] tracking-wider uppercase">
            ...
            <span>Welcome Back Wanderer</span>
          </div>
          <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">
            Log Into Tip<span className="text-brand-red font-black">2</span>Trip
          </h2>
          <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">
            Sign in to check matching travel buddies and custom itineraries.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-left">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-brand-green hover:bg-brand-green-dark text-white rounded-xl font-bold text-sm transition-all duration-300 shadow-md hover:shadow-brand-green/30 flex items-center justify-center gap-2 mt-2 cursor-pointer disabled:opacity-50"
          >
            {loading ? (
